...
export const documents: FileResource[] = [
  ...
  },
  {
   ...
   {
    title: 'Checklist 3',
    description: 'Third checklist submission planned for a future milestone.',
    href: publicFile('files/documents/checklist-3.pdf'),
    expectedPath: 'public/files/documents/checklist-3.pdf',
    type: 'PDF',
    stage: 'Future',
  },
  {
...
export const teamMembers: TeamMember[] = [
 {
  ...
  },
  {
    ...
    linkedinUrl: 'https://lk.linkedin.com/in/eshan-nayanapriya-5940b72b0',
  ...
  },
  {
    ...
    linkedinUrl: 'https://lk.linkedin.com/in/nadeesh-n',
